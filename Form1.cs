...
//TODO:
//2) Добавить корень в базовый калькулятор
//3) Добавить число пи в базовый калькулятор
//4) Добавить abs в базовый калькулятор
//5) Добавить mod  в базовый калькулятор
